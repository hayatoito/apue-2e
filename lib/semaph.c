...
static struct sembuf op_endcreate[2] = {
    1, -1, SEM_UNDO,            /* decrement [1] (proc counter) with undo
                                 * on exit */
    /*
     * UNDO to adjust proc counter if process exits before explicitly calling
     * sem_close()
     */
...
static struct sembuf op_op[1] = {
    0, 99, SEM_UNDO             /* decrement or increment [0] with undo on
                                 * exit */
        /*
         * the 99 is set to the actual amount to add or subtract (positive or
         * negative)
         */
};
